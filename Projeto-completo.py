...
VC = px.pie(dic2df, names='Produtos', values='Quantidade vendida', color='Produtos', template='plotly_dark', hole=0.3, title=f'{quanttot} produtos vendidos',
           height=500)
...
app.layout = html.Div(children=[
    html.H1(children='ANÁLISE DE VENDAS (FEVEREIRO)'),
